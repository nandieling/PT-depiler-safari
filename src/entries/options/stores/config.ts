...
export const useConfigStore = defineStore("config", {
  ...
  state: (): IConfigPiniaStorageSchema => ({
    ...
    userInfo: {
      // Safari refreshes through a logged-in site tab; serial requests avoid
      // competing navigations and tab-message timeouts on first use.
      queueConcurrency: __BROWSER__ === "safari" ? 1 : 5,
      autoReflush: {
        enabled: true,
        interval: 3, // hours
        afterTime: "00:00",
