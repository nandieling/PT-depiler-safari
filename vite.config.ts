  ...
  plugins: [
    ...
    webExtension({
      ...
      manifest: () => ({
        ...
        // Safari may not start the extension background page before the first
        // toolbar click. Opening the options UI as the action popup keeps the
        // extension immediately accessible without relying on onClicked.
        "{{safari}}.action": {
          default_icon: {
            "16": "icons/logo/16.png",
            "19": "icons/logo/19.png",
        ...
        "{{safari}}.permissions": permissions,
        "{{safari}}.optional_permissions": optionalPermissions,
        host_permissions: ["*://*/*"],
        ...
        // Apple's converter currently fails to parse the reduced manifest without this otherwise ignored block.
        ...
        "{{safari}}.content_security_policy": {
          extension_pages: "script-src 'self';",
        },
